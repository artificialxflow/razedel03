...
if (!supabaseUrl) {
  console.warn('NEXT_PUBLIC_SUPABASE_URL is not defined - this may cause runtime errors')
...
if (!supabaseAnonKey) {
  console.warn('NEXT_PUBLIC_SUPABASE_ANON_KEY is not defined - this may cause runtime errors')
  // Don't throw error during build time
  if (typeof window !== 'undefined') {
